...
//		
	...
	public void setMathAlarm(Alarm alarm) {
		...
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_NAME, "알람 제목",alarm.getAlarmName(), null, alarm.getAlarmName(), Type.STRING));
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_TIME, "알람 설정",alarm.getAlarmTimeString(), null, alarm.getAlarmTime(), Type.TIME));
